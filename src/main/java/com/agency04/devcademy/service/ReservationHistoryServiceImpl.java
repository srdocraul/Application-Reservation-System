...
@Service public class ReservationHistoryServiceImpl implements ReservationHistoryService {
    ...
    @Autowired private ReservationHistoryRepository reservationHistoryRepository;

    @Override public ReservationHistory createReservationHistory(ReservationHistory reservationHistory) {
        return reservationHistoryRepository.save(reservationHistory);
    }

    @Override public ReservationHistory updateReservationHistory(ReservationHistory reservationHistory) {
    ...
    @Override public List<ReservationHistory> getAllReservationHistory() {
        return this.reservationHistoryRepository.findAll();
    }

    @Override public ReservationHistory getReservationHistoryById(Long id) {
    ...
    @Override public void deleteReservationHistory(Long id) {
